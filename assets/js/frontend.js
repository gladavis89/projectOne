    ...
    if (input == '' || artist == '') {
      ...
      $.ajax ({
        url: 'https://ws.audioscrobbler.com//2.0/?method=' +
          ...
          '=' +
          input +
          '&autocorrect[0|1]&api_key=5a85a72189c33df2b02663c378c7f775&format=json',
        method: 'GET',
        ...
        $ ('#publication-date').text (
          'Publication Date: ' + response.track.wiki.published
        );
        ...
        $.ajax ({
          ...
          success: function (result) {
            ...
            addToFavsButton.addClass (
              'uk-button uk-button-primary uk-text-center uk-margin-auto'
            );
